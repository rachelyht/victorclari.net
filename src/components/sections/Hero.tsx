    ...
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen">
        <div className="text-center text-white px-4 py-8">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-2 sm:mb-4">Welcome to</h2>
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-2 sm:mb-4">Victor Chan</h1>
          <p className="text-lg sm:text-xl mb-6 sm:mb-8">Clarinetist / Saxophonist</p>
